...
- Full `cmark` syntax support
- Supports subheader for the first `h1` level header
- Supports Github flavored admonishes
- Supports Github flavored tables

> [!WARNING]
> Not all css styles are defined for the Markdown component, so your mileage might vary.
...
Stolen from [Markdown: Syntax](https://daringfireball.net/projects/markdown/syntax.text)
...
Checkboxes are usefull to show todo lists.

Syntax for checkboxes looks like
...
* Set of square bracket with space in between
...
* Set of square brackets with `x` character in between
* followed by the text

...
Now you need to expand the implementation of your story using one of the following functions
...
`Story::view` associated function should return the component you are writing
a story about.

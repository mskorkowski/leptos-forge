...
"############;
  ...
  /// Upper half of sample_1 of markdown
  #[test]
  fn md_sample_1_up() {
      let markdown: &str = r############"
# Leptos_forge
...
"############;
    ...
    /// 1st quarter of sample_1 of markdown
  #[test]
  fn md_sample_1_up_up() {
      let markdown: &str = r############"
# Leptos_forge
...
"############;
    ...
    /// 2nd quarter of sample_1 of markdown
  #[test]
  fn md_sample_1_up_down() {
      let markdown: &str = r############"
> [!WARNING]
>
> `leptos_forge` is still at the early stages of development and in many places
...
"############;
  ...
  /// lower half of sample 1 of markdown
  #[test]
  fn md_sample_1_down() {
      let markdown: &str = r############"
## Leptos Forge vs Storybook
